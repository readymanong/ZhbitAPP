...
public class LoginActivity extends Activity {
    ...
    private void initView() {
        ...
        // 登录页面控件
        userNumberEt = (EditText) findViewById(R.id.login_number_et);
        userPasswordEt = (EditText) findViewById(R.id.login_passwd_et);
        loginnumWarnImv = (ImageView) findViewById(R.id.login_num_warn_imv);
