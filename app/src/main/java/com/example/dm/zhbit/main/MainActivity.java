...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void setChioceItem(int index) {
        ...
        switch (index) {
            case 0:
                // 需要的话自行修改
                firstImage.setImageResource(R.drawable.ic_whatshot_teal_24dp);
            ...
            case 2:
                thirdImage.setImageResource(R.drawable.ic_home_grey600_24dp);
    ...
    private void clearChioce() {
        firstImage.setImageResource(R.drawable.ic_whatshot_grey600_24dp);
